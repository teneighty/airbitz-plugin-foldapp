...
function pluginReturn (data) {
  ...
  if (callbacks[d.cbid]) {
    callbacks[d.cbid](d.err, d.res)
    delete callbacks[d.cbid]
    return true
  } else {
    return false
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_card_template_handlebars__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_card_template_handlebars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__templates_card_template_handlebars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_add_funds_handlebars__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_add_funds_handlebars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__templates_add_funds_handlebars__);
...
__WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].loaded(function () {
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Before config')
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('BRAND').then((data) => { brand = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('API-TOKEN').then((data) => { apiToken = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('BIZID').then((data) => { bizId = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('LOGO_URL').then((data) => { logoUrl = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('CATEGORY').then((data) => { category = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["a" /* config */].get('AIRBITZ-STATS-KEY').then((data) => { statsKey = data })
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'After config')
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#reset-account').click(function () {
      ...
      if (window.confirm('Reset Account? ARE YOU SURE. All cards from all vendors will be lost?') === true) {
        if (window.confirm('Reset Account? ARE YOU REALLY SURE?') === true) {
          Account.createWithHandler(function () {
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'New account creation for reset succeeded.')
            // ui.exit()
          }, function () {
            ...
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'New account creation for reset failed.')
          })
        }
      }
    }
  ...
  function toggleUi () {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.fold-loading').css('display', 'none')
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.main').css('display', 'inline')
    ...
    user.updateUsersCards(function () {
      user.updateCardsForSale(function () {
        ...
        if (serverJsonError) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Error in Server response. Please contact support')
  ...
  if (supportsTemplate()) {
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Does support templates!')
  } else {
    // Use old templating techniques or libraries.
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Does not support templates.')
  }
  if (supportsImports()) {
    // Good to go!
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Supports imports!')
  } else {
    // Use other libraries/require systems to load files.
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Does not support imports.')
  }
  ...
  function logStats (event, brand, amount) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      success: function (response) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'logStats: recorded')
      }
    }).fail(function (xhr, textStatus, error) {
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'logStats: There was an error. Status: ' + xhr.status)
    })
  }
  ...
  function sRequestHandler (url, json, handleReponse, handleError) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'There was an error. Status: ' + xhr.status)
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, xhr.Message)
      handleError(xhr.status)
    })
  }

  const Account = {
    exists: __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.Deferred(),
    logged_in: __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.Deferred(),
    all_cards: [],
    owl: __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#user-cards'),
    owlSet: false, // Owl set
    numUpdates: 0,
    current_card_id: '', // The currently visible card id. used to ping Fold servers for balance update
    create: function () {
      Account.createWithHandler(function () {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Account created successfully')
      }, function () {
    ...
    createWithHandler: function (handleReponse, handleError) {
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Creating user.')
    ...
    login: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, Account.creds)
      ...
      const affiliateInfo = __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].getAffiliateInfo()
      if (affiliateInfo &&
    ...
    updateBalance: function () {
      this.getInfo('balances?currency=USD', function (balances) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Balance: ' + JSON.stringify(balances['balances'][0]['amount']))
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.balance-amt').text('$' + balances['balances'][0]['amount'])
      })
    },
    ...
    pingCard: function (cardid) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Pinging card ' + cardid)
      sRequestHandler(url, '', function (r) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Pinging card success')
      },
      function (e) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Pinging card failed')
      })
    },
    ...
    updateWAddr: function (addr, handleResponse, handleError) { // Set the default BTC address
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Setting default address to: ' + addr.toString())
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, withdrawUrl)
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, newAddr)
      sRequestHandler(withdrawUrl, newAddr, function (response) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Updated default_withdraw_address')
        handleResponse()
      }, function (error) {
        handleError()
      })
    ...
    updateUsersCards: function (doneUpdating) {
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Resetting cards.')
    ...
    clearOwl: function () {
      if (Account.owlSet) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Clearing Owl')
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Owl size before:' + Account.owl.data('owlCarousel').owl.owlItems.length)
        ...
        for (let i = 0; i < owlSize; i++) {
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Clearing Owl Item ' + i)
          Account.owl.data('owlCarousel').removeItem()
        }
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Owl size after:' + Account.owl.data('owlCarousel').owl.owlItems.length)
      } else { Account.owlSet = true }
    },
    getCards: function (callback) {
      user.getInfo('cards?brand_id=' + brand, function (allCardInfo) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, "User's cards: " + JSON.stringify(allCardInfo))
    ...
    updateUsersCardsUI: function (cards, doneUpdating) { // Updates the UI with cards the user has purchased
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'updateUsersCardsUI: ' + cards.length + ' cards from all brands.')
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'updateUsersCardsUI: brand: ' + brand + ': ' + cards.length)
      if (!cards.length > 0) {
        const changed = Account.haveCardsChanged(cards)
        if (changed || (!Account.owlSet)) {
          Account.all_cards = []
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'No cards. New acc!')
        ...
        if (changed === CardsChanged.YES) {
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'updateUsersCardsUI: brand: ' + brand + ': ' + cards.length + ' CARDS CHANGED')
          Account.all_cards = []
          ...
          for (c in cards) {
            ...
            if (!card.bal === 0) {
              ...
              const thisCardHTML = __WEBPACK_IMPORTED_MODULE_2__templates_card_template_handlebars___default()(thisCard)
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Adding card: ' + c + ' card info: ' + cards[c])
              if (needToClearOwl) {
                Account.clearOwl()
          ...
          for (const c in cards) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('div.card-balance-amt[card=' + card.id + ']').text(amtString)
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('div.card-number[card=' + card.id + ']').text(card.num)
          }
        }
      }
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.materialboxed').materialbox()
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.card-refund').off().on('click', function () {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Refunding button')
        const thisCardId = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).parent().parent().children('.card-info-main').children('.card-balance-amt').attr('card')
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'This card: ' + thisCardId)
    ...
    haveCardsChanged: function (cards) { // Has different cards?
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: oldcards:' + Account.all_cards.length + ' newcards:' + cards.length)

      if (cards.length !== Account.all_cards.length) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: return YES')
        return CardsChanged.YES
      }
      ...
      for (const ic in cards) {
        for (const iac in Account.all_cards) {
          if (cards[ic]['id'] === Account.all_cards[iac].id) {
            match++
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: found id match:' + cards[ic]['id'])
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: oldbal:' + Account.all_cards[iac].bal)
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: newbal:' + cards[ic]['balance'][0]['amount'])
            if (cards[ic]['balance'][0]['amount'] !== Account.all_cards[ic].bal) {
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: Balance changed card')
              balanceChanged = true
            }
          }
        }
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: matched:' + match + ' newlength:' + cards.length)
      ...
      if (balanceChanged) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'haveCardsChanged: return VALUE_ONLY')
    ...
    updateCardsForSale: function (doneListing) { // Updates the UI with cards avaliable to purchase from Fold.
      ...
      this.getInfo('brands', function (cardsAvail) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, JSON.stringify(cardsAvail))
        ...
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'minPriceRate:' + minPriceRate)

        let maxDiscount = 100 * (1.0 - minPriceRate)
        maxDiscount = maxDiscount.toFixed(0)
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.brand-discount').text(maxDiscount + '%')

        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, JSON.stringify(brandsCards['card_values']))
        user.getBal(function (totalBal) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'User bal: ' + user.total_bal)
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Max: ' + maxBal)
          let addTemplateHtml = ''
          if (maxBal >= user.total_bal) {
            const cardVals = brandsCards['card_values']
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.add-buttons').html('') // Wipe out any cards that are currently there.
            if (cardVals) {
              ...
              for (const ic in cardVals) {
                numCardsToBuy++
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Listing card ' + ic)
                const thisCard = {
                  cardValue: '<span class="card-value" value="' + cardVals[ic]['amount'] + '">' + cardVals[ic]['formatted']['all_decimal_places'] + '</span>'
                }
                addTemplateHtml = addTemplateHtml + __WEBPACK_IMPORTED_MODULE_3__templates_add_funds_handlebars___default()(thisCard)
              }
            }
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.add-buttons').html(addTemplateHtml)
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.buy-card').off().on('click', function () {
              user.purchaseCard(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).parent().parent().find('.card-value').attr('value'))
            })
          }
          if (numCardsToBuy) {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.add-funds-header').text('Buy Gift Card')
          } else {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.add-funds-header').text('Sorry, no cards available')
          }
    ...
    logRefunds: function () {
      Account.getInfo('refunds', function (refunds) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, JSON.stringify(refunds))
      })
    },
    getInfo: function (info, handleResponse, root) {
      root = typeof root !== 'undefined' ? root : 'my/'
      __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.get(foldApi + root + info).done(function (response) {
    ...
    purchaseCard: function (denomination, brandId) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Getting new order')
      ...
      sRequestHandler(url, newOrder, function (r) {
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Order: ' + JSON.stringify(r))
        const amt = (r['orders'][0]['price']['amount'] * 100000000)
        const toAddr = r['orders'][0]['payment'][0]['address']
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Spending ' + amt + ' from wallet: ' + user.abWallet + ' to: ' + toAddr)
        __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Fiat amt: ' + denomination)
          ...
          toAddr, amt, tmpAddress, affiliateAmount, {
            ...
            success: function (res) {
              if (res && res.back) {
                ...
                forceRefresh = 1
                Account.clearOwl()
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Funds were sent.')
            ...
            error: function () {
              ...
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Funds were not sent.')
            }
          })
      }, function (error) {
  ...
  Card.prototype.refund = function () {
    if (this.isRefundable) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Refunding card ' + this.id + ' amount: ' + this.bal)
        ...
        function (data) {
          Account.updateWAddr(data['address'], function () {
            sRequestHandler(url, refund, function (response) {
              ...
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, response)
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Done refunding!')
          ...
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, data)
        })
    } else {
  ...
  Card.prototype.mockBal = function (bal) {
    ...
    const thisCard = this
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.post(url,
      {'cards': [{
        'id': thisCard.id.toString(),
        'balance_amount': bal.toString()
      }]}
    ).done(function () {
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Done mocking ' + thisCard.id + ' balance to: ' + bal)
    })
  }

  // Main
  const user = Object.create(Account)
  __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].readData('fold-username').then((data) => {
    Account.username = data
    return __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].readData('fold-pass')
  }).then((data) => {
  ...
  function main () {
    if (!(typeof Account.username === 'undefined' || Account.username == null)) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'User pulled from memory.')
      user.exists.resolve()
    } else {
      user.create()
    }
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.when(user.exists).done(function (data) {
      user.login()
    })
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.when(user.logged_in).done(function (data) {
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Logged in')
      Account.owl.owlCarousel({ // Activate owl Carousel for cards.
        ...
        afterMove: function (elem) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Current card is ' + card)
      ...
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].getSelectedWallet({
        success: function (wallet) {
          updateWallet(wallet)
          const withdrawalAddress = __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].readData('withdrawal-address')
          ...
          if (!withdrawalAddress || withdrawalAddress.length < 20) {
            createAddress(Account.abWallet, brand, 0, 0, category, 'Refunded ' + brand + ' gift card.', function (data) {
              Account.updateWAddr(data['address'], function () {
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Setting withdrawal address:' + data['address'])
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].writeData('withdrawal-address', data['address'])
              }, function () {
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'WARNING: could not set withdrawal address')
                __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, data)
              })
            }, function (data) {
              __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, data)
            ...
            __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Withdrawal address already set:' + withdrawalAddress)
          }
        },
        error: function () {
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Could not get selected wallet')
          __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["c" /* ui */].showAlert('Wallet Error', 'Error could not select wallet.')
        }
      })

      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'Updating UI')
      __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["c" /* ui */].hideAlert()
    ...
    // UI stuff
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, 'logo: ' + logoUrl)
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.brand-name').text(brand)
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.brand-logo').attr('src', logoUrl)
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.user-creds').html('Username: ' + Account.username + '<br>Password: ' + Account.pass)
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.support-mail-link').html('<a href="mailto:support@foldapp.com?subject=Support%20Requested&body=' + 'Username:' + Account.username + '">support@foldapp.com.</a>')
  }
  ...
  window.onerror = function (message) {
    ...
    // ui.exit()
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, message)
  }
  ...
  try {
    ...
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["c" /* ui */].showAlert('Internal error', 'Service is unavailable at this time. Please try again later.')
    // ui.exit()
    __WEBPACK_IMPORTED_MODULE_0_airbitz_libplugin__["b" /* core */].debugLevel(1, e.toString())
  }
})
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ui_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__devmode_js__ = __webpack_require__(11);
...
/* unused harmony reexport devmode */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["loaded"] = loaded;
...
/* harmony export (immutable) */ __webpack_exports__["chooseWallet"] = chooseWallet;
/* harmony export (immutable) */ __webpack_exports__["selectedWallet"] = selectedWallet;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bridge_js__ = __webpack_require__(2);


function loaded (callback) {
  if (window.postMessage.length <= 0) {
    setTimeout(() => {
      loaded(callback)
    }, 100)
  } else {
...
function bitidSignature (uri, message) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'bitidSignature', uri, message})
}
...
function chooseWallet (options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'chooseWallet', options})
}
...
function selectedWallet (options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'selectedWallet', options})
}
...
function wallets (options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'wallets', options})
}
...
function getAddress (walletId, currencyCode) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'getAddress', walletId, currencyCode})
}
...
function finalizeReceiveRequest (wallet, requestId) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'finalizeReceiveRequest', wallet, requestId})
}
...
function broadcastTx (wallet, rawtx) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'broadcastTx', wallet, rawtx})
}
...
function saveTx (wallet, rawtx) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'saveTx', wallet, rawtx})
}
...
function requestFile (options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'requestFile', options: options})
}
...
function writeData (key, value) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'writeData', key, value})
}
...
function readData (key) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'readData', key})
}
...
function formatCurrency (currency, currencyNum, withSymbol) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({
    func: 'formatCurrency', currency, currencyNum, withSymbol
  })
}
...
function debugLevel (level, text) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'debugLevel', level, text})
}
 ...
 */
function get (key) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'get', key})
}
...
function showAlert (title, message, options) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'showAlert', title, message})
}
 ...
 */
function hideAlert () {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'hideAlert'})
}
 ...
 */
function title (s) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'title', 'title': s})
}
 ...
 */
function back () {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'back'})
}
 ...
 */
function exit () {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'exit'})
}
...
function launchExternal (uri) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'launchExternal', uri})
}
...
function navStackClear () {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'navStackClear'})
}
...
function navStackPush (path) {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'navStackPush', path})
}
...
function navStackPop () {
  return Object(__WEBPACK_IMPORTED_MODULE_0__bridge_js__["a" /* postWrapper */])({func: 'navStackPop'})
}
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"item card gift-card\">\n    <div class=\"card-image\">\n        <div class=\"card-barcode\"><div class=\"material-placeholder\">"
    + ((stack1 = ((helper = (helper = helpers.cardBarcode || (depth0 != null ? depth0.cardBarcode : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cardBarcode","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</div></div>\n    </div>\n    <div class=\"card-info-main card-content\">\n        "
    + ((stack1 = ((helper = (helper = helpers.cardNumber || (depth0 != null ? depth0.cardNumber : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cardNumber","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n        <div class=\"card-balance\">Current Balance</div>\n        "
    + ((stack1 = ((helper = (helper = helpers.cardAmount || (depth0 != null ? depth0.cardAmount : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cardAmount","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n        <div><span class=\"activator card-info\">"
    + container.escapeExpression(((helper = (helper = helpers.refundText || (depth0 != null ? depth0.refundText : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"refundText","hash":{},"data":data}) : helper)))
    + "</span></div>\n    </div>\n    <div class=\"card-reveal valign-wrapper\"><br>\n        <a class=\"waves-effect btn center card-refund valign\">Refund Card</a><br><br>\n        <span class=\"card-title grey-text text-darken-4\">Cancel</span><br>\n    </div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"collection-item avatar card-list\">\n    <div style=\"position:relative\">\n        <div style=\"position:absolute; top:50%; height:100%; margin-top:1.3em;\">\n            <span class=\"title\">"
    + ((stack1 = ((helper = (helper = helpers.cardValue || (depth0 != null ? depth0.cardValue : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"cardValue","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "</span>\n        </div>\n        <div style=\"position:absolute; top:50%; height:100%; margin-top:1.1em; right:0;\">\n            <button type=\"button\" style=\"float: right;\" class=\"buy-card\">Buy</button>\n        </div>\n    </div>\n</li>\n";
},"useData":true});
